...
const allProducts: Product[] = [
    ...
    },
    {
        ...
        description: 'Mamostong TASTE BOX Nuts & Spices offers a flavorful blend of nutty and spicy essences to elevate your protein shakes and recipes. With ingredients like matcha, chili pepper, and macadamia, it provides natural antioxidants and a rich taste experience.',
        description2: 'A premium blend featuring natural extracts and plant-based ingredients for enhanced nutrition and flavor.',
        ingredients: 'Chili Pepper, Matcha, Vanilla, Coconut, Macadamia, Pecan, Peanut. May include natural extracts, plant-based proteins, vitamins, minerals, antioxidants, and more.',
        certifications: 'Organic Certified, Non-GMO, Gluten-Free',
        finalMessage: 'TASTE BOX Nuts & Spices transforms your protein drinks into a gourmet experience. Mix and match flavors to discover your perfect combination. Perfect for adding warmth and depth to drinks and recipes alike. Find your favorite nutty and spicy combinations with Mamostong TASTE BOX Nuts & Spices. Elevate your daily nutrition with every sip!',
    ...
    },
    {
        ...
        description: 'Mamostong TASTE BOX Berries brings the essence of nature\'s finest berries to your protein routine. Featuring raspberry, strawberry, and cranberry, it offers refreshing and vibrant flavors packed with antioxidants.',
        description2: 'A refreshing blend of natural berry extracts rich in antioxidants.',
        ingredients: 'Raspberry, Cherry, Strawberry, Cranberry. May include natural extracts, plant-based proteins, vitamins, minerals, antioxidants, and more.',
        certifications: 'Organic Certified, Non-GMO, Gluten-Free',
        finalMessage: 'TASTE BOX Berries is a refreshing blend that pairs perfectly with your protein shakes or desserts. The natural berry extracts offer a sweet and tart balance, ideal for a health-conscious lifestyle. Brighten your day with the fruity goodness of Mamostong TASTE BOX Berries. Energize your drinks with fresh berry flavors!',
        size: '24 Sachets (5g each)',
        images: [
    ...
    },
    {
        ...
        description: 'Mamostong TASTE BOX Fruit captures the vibrant flavors of tropical and orchard fruits, bringing a refreshing twist to your protein shakes. Perfect for creating unique fruity combinations every day.',
        description2: 'A tropical blend of fruit extracts for enhanced flavor and nutrition.',
        ingredients: 'Date, Pear, Peach, Papaya, Lichi, Mango, Banana, Maple Syrup. May include natural extracts, plant-based proteins, vitamins, minerals, antioxidants, and more.',
        certifications: 'Organic Certified, Non-GMO, Gluten-Free',
        finalMessage: 'TASTE BOX Fruit delivers a tropical punch of flavor, offering endless combinations for smoothies, shakes, and even baked goods. Explore the possibilities of fruity indulgence. Escape to the tropics with Mamostong TASTE BOX Fruit. A world of vibrant flavors in every sachet!',
        size: '24 Sachets (5g each)',
        images: [
    ...
    },
    {
        ...
        description: 'Mamostong TASTE BOX Herbs adds herbal sophistication to your protein routine. With notes of basil, mint, and lavender, it offers a calming, aromatic experience for drinks and recipes.',
        description2: 'A sophisticated blend of herbal extracts for a unique taste experience.',
        ingredients: 'Basil, Mint, Rose, Lavender. May include natural extracts, plant-based proteins, vitamins, minerals, antioxidants, and more.',
        certifications: 'Organic Certified, Non-GMO, Gluten-Free',
        finalMessage: 'TASTE BOX Herbs provides a soothing blend of herbal flavors that transform your protein shakes into a wellness ritual. Great for teas, smoothies, and baking. Find your moment of calm with Mamostong TASTE BOX Herbs. Subtle flavors to soothe your senses.',
        size: '24 Sachets (5g each)',
        images: [
    ...
    },
    {
        ...
        description: 'Mamostong TASTE BOX Citrus bursts with zesty, refreshing flavors of pineapple, orange, and pomegranate. Perfect for revitalizing your protein shakes with a splash of citrus.',
        description2: 'A vibrant blend of citrus extracts for an energizing boost.',
        ingredients: 'Pineapple, Sicilian Orange, Orange, Lemon, Pomegranate, Lemongrass. May include natural extracts, plant-based proteins, vitamins, minerals, antioxidants, and more.',
        certifications: 'Organic Certified, Non-GMO, Gluten-Free',
        finalMessage: 'TASTE BOX Citrus brings brightness to your drinks with its tangy and uplifting flavor combinations. Mix and match for a revitalizing experience. Revitalize your routine with Mamostong TASTE BOX Citrus. A burst of sunshine in every sachet.',
        size: '24 Sachets (5g each)',
        images: [
    ...
    },
    {
        ...
        description: 'Mamostong TASTE BOX Chocolate offers indulgent flavors like milk chocolate, white chocolate, and coffee to elevate your protein shakes or recipes with a rich, satisfying taste.',
        description2: 'A luxurious blend of chocolate varieties for a guilt-free treat.',
        ingredients: 'White Chocolate, Milk Chocolate, Dark Chocolate, Coffee, Cola. May include natural extracts, plant-based proteins, vitamins, minerals, antioxidants, and more.',
        certifications: 'Organic Certified, Non-GMO, Gluten-Free',
        finalMessage: 'TASTE BOX Chocolate is the ultimate treat for chocolate lovers. Perfectly balanced to enhance protein drinks or baked goods with velvety richness. Indulge guilt-free with Mamostong TASTE BOX Chocolate. Pure chocolatey goodness in every sip!',
        size: '24 Sachets (5g each)',
        images: [
